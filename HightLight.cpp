...
#define FileNAME "HightLight.ini"
...
plugmod_t* idaapi init(void)
{
	...
	msg("**********HightLight tool************************\n");
	msg("**********Fix some cases crash, Update By XiaLuoHun: 2021-08-30**********\n");
	return PLUGIN_KEEP;
}
...
const char help[] = "Hotkey to set colors is Alt-5";             ///< Multiline help about the plugin
